export default {
  ...
  settings: {
    ...
    updates: {
      title: 'fnOS 原生包更新',
      description: '检查 GitHub Release 里的最新 Hermes Studio FPK。飞牛应用中心的原生升级仍使用 FPK 包，Hermes 与 Web UI 版本由打包流程统一带入。',
      check: '检查更新',
      notChecked: '未检查',
      status: '状态',
      available: '发现新版本',
      availableHint: 'GitHub Release 已发布 {version}，可以下载 FPK 后通过飞牛应用中心或 appcenter-cli 更新。',
      upToDate: '已是最新',
      upToDateHint: '当前安装版本与 Release 元数据一致。',
      unavailable: '检查失败',
      checkFailed: '无法检查更新',
      checkFailedHint: '请确认 NAS 可以访问 GitHub Release 元数据。',
      currentVersion: '当前版本',
      latestVersion: '最新版本',
      releaseTag: 'Release 标签',
      servicePort: '服务端口',
      gatewayPrefix: '网关路径',
      bundledRuntime: '内置运行环境',
      updatedAt: '发布时间',
      checkedAt: '检查时间',
      metadataUrl: '元数据地址',
      downloadFpk: '下载 FPK',
