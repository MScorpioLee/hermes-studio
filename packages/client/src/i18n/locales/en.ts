export default {
  ...
  settings: {
    ...
    updates: {
      title: 'fnOS Native Package Updates',
      description: 'Checks the latest Hermes Studio FPK published on GitHub Releases. Native fnOS upgrades still use the FPK package, while Hermes and Web UI versions are bundled by the package build.',
      check: 'Check for updates',
      notChecked: 'Not checked',
      status: 'Status',
      available: 'Update available',
      availableHint: 'GitHub Release has published {version}. Download the FPK and update it through fnOS App Center or appcenter-cli.',
      upToDate: 'Up to date',
      upToDateHint: 'The installed version matches the release metadata.',
      unavailable: 'Check failed',
      checkFailed: 'Unable to check for updates',
      checkFailedHint: 'Confirm that the NAS can reach the GitHub Release metadata.',
      currentVersion: 'Current version',
      latestVersion: 'Latest version',
      releaseTag: 'Release tag',
      servicePort: 'Service port',
      gatewayPrefix: 'Gateway path',
      bundledRuntime: 'Bundled runtime',
      updatedAt: 'Published at',
      checkedAt: 'Checked at',
      metadataUrl: 'Metadata URL',
      downloadFpk: 'Download FPK',
      openRelease: 'Open Release',
      cliInstall: 'CLI update command',
    },
    display: {
