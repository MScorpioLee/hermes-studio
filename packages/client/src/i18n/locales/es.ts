...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      managementHint: 'Requiere Hermes Agent 0.17.0 o posterior. Al activarlo, Web UI escribe gateway.multiplex_profiles para que el gateway default sirva todos los perfiles. Al desactivarlo elimina esa configuración.',
