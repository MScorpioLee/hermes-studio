...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      managementHint: 'Nécessite Hermes Agent 0.17.0 ou ultérieur. Si activé, la Web UI écrit gateway.multiplex_profiles afin que le gateway default serve tous les profils. Désactiver retire cette configuration.',
