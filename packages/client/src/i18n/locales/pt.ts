...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      managementHint: 'Requer Hermes Agent 0.17.0 ou superior. Quando ativado, a Web UI grava gateway.multiplex_profiles para o gateway default servir todos os perfis. Ao desativar, remove essa configuração.',
