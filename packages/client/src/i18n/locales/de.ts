...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      managementHint: 'Erfordert Hermes Agent 0.17.0 oder neuer. Wenn aktiviert, schreibt die Web UI gateway.multiplex_profiles, damit das default gateway alle Profile bedient. Beim Deaktivieren wird diese Einstellung entfernt.',
